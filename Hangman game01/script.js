...
//word array
const question = [
  "The Chosen Category Is SEDC Students",
  "The Chosen Category Is Cars",
  "The Chosen Category Is Cities In Macccedonia"
];
...
const hints = [
  ...
  [
    "PRODUCED BY DAIMLER GERMANY",
    "BAVARIAN AUTO",
    "ONA SO KONJCETO",
    "ITALIANSKA KANTA",
    "GERMANSKA SO GROMCE NA LOGO",
    "LOGO KAO ZA NA OLIMPIJADA",
    "JA NAPRAVIL HENRY () VO  MICHIGAN",
    "SWEDISH CAR",
    "GERMAN CAR",
    "ASIAN CAR",
    "ASIAN CAR",
  ...
  [
    "NAJDOBRA PASTRMAJLIJA",
    "NAJZAGADEN GRAD, GLAVEN GRAD",
    "GRAD NA KONZULITE",
    "AJVARSKI PIPER",
    "CAMCI STO GI NAREKUVAAT PASTRMAJLII",
    "NEMA DRUGA",
    "MAJMUNCINJA SO PIVO",
    "POJMA NEAM",
    "SO LAJCA DA IM SRKAS OD EZERONO"
  ]
];
